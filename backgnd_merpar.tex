...
This restriction greatly simplifies the implementation in two ways:
Firstly,
...
\paul{Hi Zoltan,
do you think this statement about speculative execution is too strong for my
    potential examiners?
    I think a Haskell programmer might not like hearing this.}
Secondly,
code that might have no solutions entails speculative execution,
which is often not worth parallelising.
...
this example shows how an arbitrary number of parallel conjuncts are
handled.
