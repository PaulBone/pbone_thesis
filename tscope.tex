...
\metrictopic{Parconj runnable self and desc}
is the number of CPUs that can be used by a given parallel conjunction
and its descendants.
...
\metric{Parconj runnable self and desc},
...
\metrictopic{Parconj running self and desc}
is the number of CPUs that are actually used by a given parallel conjunction
and its descendants.
This metric has the same relationship to
\metric{Parconj running self}
as \metric{Parconj runnable self and desc} has to
\metric{Parconj runnable self}.
...
\metrictopic{Parconj avail CPUs}
...
we can also compute \metric{Parconj running self and desc},
