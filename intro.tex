...
\status{This chapter is currently rubbish, it si very much a draft and will
change greatly.
Start reading at Chapter 2 as it is both better for learning what I am doing
and where valuable proof reading should begin.
}

\paul{Say that it is worse to over-parallelise than to under-parallelise.
    Say that this is one of the major goals of our work, and what seperates our work from others'.
}
...
\status{The rest of this section is incomplete, I do not even have an
outline}
