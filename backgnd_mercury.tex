...
in the remainder of this thesis we will use the word predicate to refer to
either a predicate or a function.

A predicate or function $P$ is defined as:
...
\noindent
Both predicates and functions are defined in terms of a goal ($G$),
there a many different goal types:
...
The mode of a predicate describes any \emph{instantiation state} changes of
