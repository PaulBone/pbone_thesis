...
Univeral quantifications do not appear in the compiler's internal goal
representation.
Similarly,
...
Nevertheless, We will not discuss negations in this diseration,
since our algorithms' handling of negations is equivilent
...
\noindent
A value of this type is a discrimininated union;
...
seperated by the \code{>>} symbol.
The instanation states are the same if nothing changes.
...
\paul{Consider rephrasing this, it is better but not great.}
The instanation state of each variable is known at every point
within a procedure,
therefore
...
\noindent
Examples of determinism declrations can be seen above in the declarations for
