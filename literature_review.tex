...
Similar techniques can be used with independent AND-parallel Prologs.

This management of variables is simple compared to that required by
dependent AND-parallel prologs.
...
In dependent AND-parallel systems this is much more difficult.
Andorra Prolog \citep{haridi:1990:andorra} handles this by modeling the
