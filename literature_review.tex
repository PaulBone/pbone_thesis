...
\cite{harris:2005:haskell-stm,mika:mercury-stm}.
...
continue~\cite{trinder:98:strategies}.
...
\cite{conway:2002:par,wang_hons_thesis,wang_dep_par_conj}.
...
Parlog~\cite{clark:84:parlog_sys_prog,clark:86:parlog} and GHC~\cite{ueda:ghc}.
...
problems~\cite{lopez96:distance_granularity,shen_98_granularity-control}.
...
tasks such as NESL~\cite{blelloch:95:nesl} and Data Parallel
...
Mercury~\cite{tannier:2007:parallel_mercury} also uses profiler feedback
