...
A potential explaination is that in different runs different numbers of
...
(usually less).
Fortunatly there is a better explaination.
...
shceduled sparks do not count towards the context limit.
We did to test 
