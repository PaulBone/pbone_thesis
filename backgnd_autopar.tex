...
\paul{
I want to understand which pages of the final book will be fancing one another
so that I can try to put the Figures \ref{fig:prof_fb} and Figure
\ref{fig:call_tree5} on facing pages, if not the same page.}
...
\paul{This needs to be floated to the page oppisite its explaination.}
