...
Or is this section a motivation for a discussion of the deep profiler?}

\status{The points that need discussing here are:}

\paul{This section \emph{must} say that this work contributed to my honours degree.
This statement goes beyond self-citation.
This is MSGR's rule}.
