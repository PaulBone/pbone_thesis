...
\paul{
This contains a high level discussion of what I'm trying to
accomplish.}
...
\paul{
(Prolog, Mercury, Haskell,
Data-parallel languages such as DpH).
}
...
\section{History of Parallelism in Mercury}

\paul{
I will have given an overview of parallelism in Mercury in the
previous section.  So in this section I would like to describe how
parallelism in Mercury is implemented.  This is where terms such as
engine, context, spark etc should be introduced, as well as a
discussion about how the RTS handles these objects.
}
