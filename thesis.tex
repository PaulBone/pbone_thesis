...
Linda Stern,
Bernie Pope,
Harold Sondergaard \paul{Spelling},
Lee Naish.
...
Finantial contributors.
Australian Postgraduate Award,
NICTA Top-up Scholarship,
Melbourne Abroad Traveling Scholarship (ICLP \& Cambridge),
...
Simon Peyton-Jones,
and others who atended the ThreadScope summit in Cambridge.

My friends,
Amanda \& Chaz Dean,
Lucus \& Jen Willson-Richter,
...
My parents, (family of origin).
Finally, My wife (new family).
% It's a good cognative pactice to seperate families in your mind like this,
% Then when beginning a new family you can choose which norms from your
% family of origin you want in the new family and which you don't.  It makes
% this decision explicit rather than accidential.
% But this is not related to the prose in the thesis.
...
\status{The points that need discussing here are:}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \paul{This needs to be moved from the overlap paper}

        \item We did write code in the compiler to act on feedback, but no
        feedback was ever identified by the analysis at this time, so this
        was untested.
    \end{itemize}
