...
% XXX: Actually implment the case for inferring Elses' coverage.
...
% A good reader might realize that we've only discussed a foward pass,
% more complicated passes are possible but the reader will have to take
% in on faith that this will be discussed later in this chapter.
