...
\paul{I can't get a paper of the reference I want
\cite{box-model}, so I don't know what's in the paper}
...
\begin{algorithm}
\paul{XXX: I want to fix the spacing between rows, where a row is larger tha a
single line the spacing is wrong}
\[
\begin{array}{l @{}l @{}l}
\prodtime V\,& G                            &=
    \begin{cases}
...
The case for foreign calls doesn't measure the call sequence count for the
...
\paul{I'm going to set out an Algorithm for this, and show the differences.
But I'd like feedback about the algorithm above first,
