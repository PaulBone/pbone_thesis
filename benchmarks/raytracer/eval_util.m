...
write_nice_exception(E, !IO) :-
    ...
    ->
        ...
        write_stack(Stack, !IO)
    ;
        univ_to_type(E, stack_env_token_exception(Msg, Env, Stack, Token))
    ->
...
:- pred write_env_entry(id::in, value::in, io.state::di, io.state::uo) is det.
...
:- pred write_stack_entry(value::in, io.state::di, io.state::uo) is det.
