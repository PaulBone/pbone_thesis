...
main(!IO) :-
    ...
    (
        ...
        getopt.lookup_bool_option(OptionTable, dependent, Dependent),
        getopt.lookup_int_option(OptionTable, target_parallelism, TargetPar),
        getopt.lookup_string_option(OptionTable, time_filename, TimeFileName),
        (
            Dependent = yes,
            set_dependent(1, !IO)
        ;
        ...
        set_target_parallelism(TargetPar, !IO),
...
option_defaults(dependent, bool(no)).
