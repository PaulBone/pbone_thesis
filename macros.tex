...
\newcommand{\trystealspark}{\code{try\_steal\_spark()}\xspace}
\newcommand{\tryruncontext}{\code{try\_run\_context()}\xspace}
\newcommand{\tryrunlocalspark}{\code{try\_run\_local\_spark()}\xspace}
\newcommand{\enginesleepsync}{\code{engine\_sleep\_sync}\xspace}
\newcommand{\wakeengine}{\code{wake\_engine}\xspace}
