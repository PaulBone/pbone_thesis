...
we seperate the program's execution time into two alternating phases:
...
Idealy this would remove the bottleneck described above.
However,
...
These types of costs prevent us from acheiving the theoretical maximum
