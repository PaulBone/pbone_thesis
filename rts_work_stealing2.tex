...
%
% This float is invisible and used only to group the following three
% algorithms which do not /float/ because they have the position H.
% We do this to place the three algorithms together on a seperate page.
%
\begin{float}[p]
