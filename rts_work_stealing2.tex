...
depending on the value of the \code{action} field,
either re-check the run queue or exit.
We have not shown the code that inspects the \code{action} field and acts on
its value.
...
and retrieves and acts on the value of the \code{action} field.
We have shown the full switch/case statement for interpreting the value of
\code{action} in \sleep.
