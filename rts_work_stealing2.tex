...
sleep,
and \code{wake\_sem} is used by other engines to control their mutual
...
\paul{XXX: Check a newer version of this code to see how it handles
potential races that could cause it to drop a context.}
...
Before we describe the algorithms for waking sleeping engines,
...
\plan{Show the code for waking engines.}
