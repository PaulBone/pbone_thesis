...
Using \tscope (Chapter \ref{chap:tscoe}),
...
We compiled in support support for \tscope;
...
mandelbrot\_highalloc benefits less from parallelism in the garbage
collector than raytracer because it spends less time doing garbage
collection.
Similarly, it benefits more from parallelism in Mercury than raytracer
...
elapsed time}
These results initially lead us to believe that
