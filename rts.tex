...
\footnote{
        ...
        We clarify this terminogy below.}
    of the deque.
...
We have removed Mercury's global spark queue,
as work stealing does not use one.
And we now refer to Mercury's context local spark stacks as context
local deques,
they already use the deque data structure,
as Wang had always planned to implement work stealing.
\paul{Can I make such a statement about another researcher's
intentions?}
...
\plan{Local deque useage}
deques are used as stacks.
hot end.
