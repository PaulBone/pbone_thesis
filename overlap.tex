...
\status{I will proof read this section later}
...
They make it easy to implement efficient explicit parallelism.
...
worthwhile \citep{lopez96:distance_granularity},
...
The first is our earlier work in \citet*{bone:2008:hons}\footnote{
    ...
    to the degree of Batchelor of Computer Science Honours at The University of
    Melbourne}
...
Most critically it did not attempt to calculate the costs of recursive
calls,
and therefore failed to find any parallelism in any of the test programs we
used,
including the raytracer from section \ref{sec:overlap_perf}.
...
Conjunctions with a single variable can significantly vary in
...
\citeauthor{Pontelli97automaticcompile-time}'s overlap calculation is
...
This is also related to our nondeterministic search for the most optimal
parallelisation as changes anywhere within a conjunctions execution can
affect other parts of the conjunction:
...
after we present the work in the next chapter.
