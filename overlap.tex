...
\status{This section is WIP,  Currently I'll setting up the benchmarks}
...
profiler.
Conversly, the results with optimisations enabled are the results that one
...
conjuncts that are neiter the left and right most conjuncts
...
code.
However, our current approch handles the 78\% majority of cases correctly,
...
\paul{Throttle recursive parallelism based on the cost of each interation.}
\paul{Handle other recursion times inteligently.}
