...
The amount of parallelism available can be represented by overlapping boxes 
such as in 
...
The algorithms for calculating these variable use times are described in 
...
previous section.
The changes necessary are not algorithmic changes.
...
%For singly recursive procedures (the most common recursion type)
