...
\paul{Rename to singly recursive, I think this is more descriptive}
...
algorithm.
It would create poor performance in sequential code and therefore we are not
interested in such cases when parallelising code.
We say that the average deepest recursion of divide and conquer code is:
...
\paul{Say how this work differes from my honours work.}
