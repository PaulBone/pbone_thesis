...
\begin{algorithm}
\begin{algorithmic}[5]
\Procedure{overlap\_simple}{$SeqTime_q$, $VarUseList_q$, $ProdTimeMap_p$} 
...
\paul{XXX: VarUseList or VarUsesList}
...
\status{I will run the benchmarks again and then fixup this section.}
