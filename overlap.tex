...
that conjuncts of the conjunction should be executed in parallel with one
another.
This simple change can also be done automatically.
However creating too much parallelism (by parallelising too many
conjunctions can actually slow the program down.
...
Autoparallelising compilers have therefore
...
We present a set of algorithms for recognising places in a program
