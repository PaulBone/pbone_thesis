...
The deep profiler provides deep cost data, but it does not provide deep
coverage data.
Coverage data is collected once per source procedure in the \PS structure as
follows.
...
%allows coverage to be infered for all program points.
...
In section \ref{sec:backgnd_coverage} we described the prior implementation
of coverage profiling.
In summary,
coverage data is stored in the \PS structure using two arrays and an integer
describing the arrays' lengths.
...
This design was initially adiqute, simple and would increase memory usege
...
\multicolumn{2}{c|}{\textbf{Static}} & \multicolumn{2}{c|}{\textbf{Deep}} &
    \C{\textbf{Code}} \\
\Cbr{\textbf{Coverage}} & \Cbr{\textbf{Cost}} & 
\Cbr{\textbf{Coverage}} & \Cbr{\textbf{Cost}} & \\ 
\hline
 7,851 & 3,358 & 2,689 & 3,898,634 & \code{foldl3(P, Xs0, !Acc1, ...) :-} \\
     - &     - &     - &         - & \code{~~~~(} \\
 2,142 &     0 &     1 &         0 & \code{~~~~~~~~Xs0 = []} \\
     - &     - &     - &         - & \code{~~~~;} \\
