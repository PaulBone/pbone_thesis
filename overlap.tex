...
\status{Draft finished, I don't know if I'll read this myself before asking
for reviews or not}
...
(these values are estimates) but only very breifly,
...
The next overhead is on line 18, the cost of signaling a future.
