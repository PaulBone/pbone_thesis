...
If the \emph{consumer} of the variable attempts to retrive the variable's value 
before it has been produced, then its execution is blocked
until until the \emph{producer} makes the variable available.
...
Section~\ref{sec:overlap_approach} outlines our general approach,
...
This is described in more detail in section \ref{sec:backgnd:autopar}.
Also described in this section \ref{sec:backgnd_autopar} are:
Mercury's deep profiler,
coverage profiling,
and variable use analysis.
We will refer to all of these in this chapter.
